...
{/if}
		...
		<script type="text/javascript" src="{$smarty.const.prototype_url}/prototype.js"></script>
		<script type="text/javascript" src="{$smarty.const.scriptaculous_url}/scriptaculous.js?load=effects"></script>
